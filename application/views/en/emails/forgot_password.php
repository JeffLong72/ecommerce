...
<body>
	<div>
		...
		<p style="Margin-top: 0;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 25px">
			Hello,<br /><br />
			Either you, or someone pretending to be you, has requested a password reset for your customer account at <?php echo base_url();?><br /><br />
			Please click on the link below to reset your password.<br />
			<?php echo base_url();?>user/reset_password/<?php echo $token;?>.html
			<br /><br />
			If you did not request this password reset you do not need to take any action.
		</p>
	</div>
</body>
</html>